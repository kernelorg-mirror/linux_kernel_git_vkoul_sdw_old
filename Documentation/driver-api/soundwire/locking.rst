...
SoundWire Bus lock is a mutex lock and is part of Bus data structure
...
SoundWire message transfer lock. This mutex lock is part of
Bus data structure (sdw_bus). This lock is used to serialize the message
transfers (read/write) within the SoundWire Bus instance such as programming
Slave registers or broadcasting message on Bus during bank switch operation.

Example
=======

Below shows how locks are acquired during prepare operation for
stream with Master 1 and Slave 1.
